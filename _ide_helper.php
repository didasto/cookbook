...
namespace Illuminate\Support\Facades {
     ...
     * @method static \Illuminate\Http\Client\Response       get(string $url, null|array|string $query = null)
     * @method static \Illuminate\Http\Client\Response       head(string $url, null|array|string $query = null)
     ...
     * @method static \Illuminate\Routing\RouteRegistrar middleware(null|array|string $middleware)
...
namespace Spatie\LaravelIgnition\Facades {
    ...
    class Flare
    {
        ...
        /**
         * @return \Spatie\FlareClient\array<int, class-string<FlareMiddleware>|FlareMiddleware>
         *
         * @static
         */
        public static function getMiddleware()
        ...
        /**
         * @param \Spatie\FlareClient\array<FlareMiddleware>|\Spatie\FlareClient\class-string<FlareMiddleware>|\Spatie\FlareClient\FlareMiddleware\FlareMiddleware $middleware
         *
...
namespace {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
         ...
         * @param null|\Closure         $callback
         *
         * @return \Illuminate\Database\Eloquent\Collection|\Illuminate\Database\Eloquent\Model|mixed|static|static[]
         *
         * @static
         */
         ...
         *
         * @param \Illuminate\Database\Eloquent\Collection<\Illuminate\Database\Eloquent\Model>|\Illuminate\Database\Eloquent\Model $related
         ...
         *
         * @param null|\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Query\Expression|string $column
         * @param string                                                                                        $direction
         *
         * @return \Illuminate\Database\Query\Builder
         *
